...
docker run -dit --name core  --network neuro --restart always --log-driver local --log-opt max-size=128m --log-opt max-file=4 --log-opt compress=true -p 1337:1337 registry.gitlab.com/neurochaintech/core/prod/release:stable
